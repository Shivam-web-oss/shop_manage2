  ...
  return (
    <article className="group overflow-hidden rounded-[30px] border border-[var(--border)] bg-[linear-gradient(180deg,rgba(19,24,24,0.96),rgba(14,18,18,0.96))] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.24)] transition hover:-translate-y-1 hover:border-[rgba(201,246,199,0.22)] hover:shadow-[0_24px_60px_rgba(0,0,0,0.34)]">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3 text-sm">
        <Link href={`/business/shops/${id}`} className="rounded-full bg-[var(--accent)] px-4 py-2 font-medium text-[#08100c] transition hover:bg-[#dbffda]">
          View details
        </Link>
        <Link href="/business/orders" className="rounded-full border border-[var(--border)] px-4 py-2 font-medium text-[var(--foreground)] transition hover:bg-white/5">
          Open orders
        </Link>
