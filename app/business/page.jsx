...
import SectionHero from "../components/business/section-hero"
import ShopCard from "../components/business/shop-card"
import { getUserDashboards } from "@/lib/business"

function buildShopMetrics(index) {
...
export default async function DashboardPage() {
  ...
  const quickActions = [
    { href: "/business/create", label: "Add Another Shop", style: "primary" },
    { href: "/business/inventory", label: "Review Inventory", style: "secondary" },
    { href: "/business/reports", label: "Open Reports", style: "secondary" },
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-8">
      <SectionHero
        ...
        secondaryAction={{ href: "/business/reports", label: "See Reports" }}
      >
