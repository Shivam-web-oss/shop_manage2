  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-8">
      <SectionHero
        ...
        description="Track stock health across your shops. This page gives the inventory button in the dashboard and navigation a real operational destination."
        primaryAction={{ href: "/dashboard/create", label: "Add Shop" }}
        secondaryAction={{ href: "/dashboard/reports", label: "Inventory Reports" }}
      />
              ...
              {inventoryRows.map((row) => (
                <tr key={row.id} className="border-b border-slate-100 last:border-b-0">
                  ...
                  <td className="px-4 py-4">
                    <Link href={`/dashboard/shops/${row.id}`} className="rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold text-white">
                      Open shop
                    </Link>
                  </td>
                </tr>
